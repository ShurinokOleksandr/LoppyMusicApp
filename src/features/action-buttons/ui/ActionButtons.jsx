...
export const ActionButtons = ({className}) => {
    return (
        <Flex className={className}>
            <MusicControlButton className={'w-12 mx-3  font-bold bg-white border-2 border-red-500 rounded-2xl p-3 text-[red] hover:scale-110 hover:duration-500'}>
                <PlayIcon fill={'red'} />
            </MusicControlButton>
            <MusicControlButton className={'w-8 mx-3 hover:scale-110 hover:duration-500'}>
                <HeartIcon />
            </MusicControlButton>
            <MusicControlButton className={'w-8 mx-3 hover:scale-110 hover:duration-500'}>
